...
#' @param interval A number setting the criterion of the confidence intervals. There are three choices: .01, .05, and .1, corresponding to 99%, 95%, and 90% confidence intervals. The default value is .05.
