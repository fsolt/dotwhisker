...
dwplot(all_results) + facet_grid(predictor~., scales = "free_x") + coord_flip() + 
    xlab("Estimated Coefficient (Dollars)") + ylab("Diamond Clarity") +
...
#     mutate(model = 1) %>% arrange(predictor) 
# 
# dwplot(all_results) + coord_flip() + facet_grid(predictor~., scales = "free")
